...
+" <img src="+picture.medium+" alt="+name.first + " " + name.last + " class='img-modal'" + " />"
    + "<div>"
      + "<h2 class='modal_info-name' >" + name.first+ " "+ name.last + "</h2>"
       +"<p class='modal_info-email'>"+ email+ "</p>"
       +"<hr />"
       +"<p>"+phone+ "</p>"
       + "<p modal_info-address'>"+ street.number+ " "+ street.name+ " " + city+", "+ state+ " "+ postcode +"</p>"
       +"<p modal_infor-birthday><strong>Birthday :</strong> " +date.getMonth()+"/"+date.getDate()+"/"+date.getFullYear()+"</p>"
    +" </div>"
   +"</div>"
;
...
search.addEventListener('keyup', function(e) {
  var Cards = document.querySelectorAll('.directory-container__card');
